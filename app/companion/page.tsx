    ...
    <div className="min-h-screen bg-[#F0F2F5] flex font-sans text-[#111827] antialiased select-none">
      ...
      <aside className="w-[260px] bg-white border-r border-[#E5E7EB] flex flex-col h-screen sticky top-0 shrink-0 shadow-[4px_0_24px_rgba(0,0,0,0.015)]">
        ...
        <div className="px-4 mb-4">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200/80 rounded-xl text-xs focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all placeholder:text-slate-400"
            />
          </div>
        </div>
        ...
        <nav className="flex-1 overflow-y-auto px-3 space-y-1 scrollbar-thin">
          ...
          <Link
            href="/"
            className="w-full flex items-center gap-3 px-3 py-3 text-sm font-medium rounded-xl text-[#6B7280] hover:bg-slate-50 hover:text-[#111827] transition-all cursor-pointer text-left"
          >
        ...
        <div className="max-w-2xl mx-auto w-full bg-gradient-to-tr from-[#0F172A] to-[#1E40AF] rounded-3xl p-8 shadow-md flex items-center justify-between mb-6 relative overflow-hidden group">
          ...
          <div className="space-y-2 z-10 max-w-sm">
            ...
            <h2 className="text-3xl font-extrabold text-white leading-tight">
              Clary <span className="text-blue-400">✦</span>
            </h2>
              ...
              filteredThreads.map((thread) => {
                ...
                return (
                  <div
                    ...
                    } hover:bg-slate-50 hover:border-slate-350 rounded-2xl shadow-[0_2px_4px_rgba(0,0,0,0.01)] cursor-pointer transition-all flex justify-between items-start gap-4`}
                  >
                    ...
                    <button
                      ...
                      className="opacity-0 group-hover:opacity-100 p-1.5 hover:bg-red-50 text-slate-400 hover:text-red-655 rounded-lg transition-all cursor-pointer shrink-0"
